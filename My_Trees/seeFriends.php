                                ...
                                <div class="modal-content">
                                    <div class="modal-header bg-primary text-white">
                                        <h5 class="modal-title" id="detailsModalLabel-<?php echo md5($friendName); ?>">
                                            Detalles de las Compras de <?php echo htmlspecialchars($friendName); ?>
                                        </h5>
                                        ...
                                        <ul class="list-group">
                                            <?php foreach ($trees as $tree) { ?>
                                                <li class="list-group-item">
                                                    <strong>Especie:</strong> <?php echo htmlspecialchars($tree['especie']); ?><br>
                                                    <strong>Nombre Científico:</strong> <?php echo htmlspecialchars($tree['nombre_cientifico']); ?><br>
                                                    <strong>Tamaño:</strong> <?php echo htmlspecialchars($tree['tamaño']); ?><br>
                                                    <strong>Ubicación Geográfica:</strong> <?php echo htmlspecialchars($tree['ubicacion_geografica']); ?><br>
                                                    <strong>Estado:</strong> <?php echo htmlspecialchars($tree['estado']); ?><br>
                                                    <strong>Precio:</strong> <?php echo htmlspecialchars($tree['precio']); ?><br>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header bg-warning text-white">
                                            <h5 class="modal-title" id="editModalLabel-<?php echo $tree['id']; ?>">Editar Árbol</h5>
                                            <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
